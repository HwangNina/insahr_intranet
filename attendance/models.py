...
class Attendance(models.Model):
    ...
    written_by = models.ForeignKey(Employee, verbose_name=_(""), on_delete=models.CASCADE)
    amended_by = models.ForeignKey(Employee, verbose_name=_(""), on_delete=models.CASCADE)
